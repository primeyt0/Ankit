...
api_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEyNiIsImVtYWlsIjoibWFuaXNocmVkZHk0NTYuMTE3QG91dGxvb2suY29tIiwidGltZXN0YW1wIjoxNzYzNjUwMjQ4LCJ0ZW5hbnRUeXBlIjoidXNlciIsInRlbmFudE5hbWUiOiJhYWNoYXJ5YWF5dXJ2ZWRhX2RiIiwidGVuYW50SWQiOiIiLCJkaXNwb3NhYmxlIjpmYWxzZX0.EgVb5dJZp4RzJ089ozjJUvO0jI4lJDadZ1cRwZB8sNk"
cwtoken = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6IjgxMTYzMiIsImVtYWlsIjoicmFqYXVhbGtoYW4zMzcyQGdtYWlsLmNvbSIsInRpbWVzdGFtcCI6MTc2NjM4MTE1OCwidGVuYW50VHlwZSI6InVzZXIiLCJ0ZW5hbnROYW1lIjoiYWFzaF9kYiIsInRlbmFudElkIjoiIiwiZGlzcG9zYWJsZSI6ZmFsc2V9.Z5QavlAZFIpexZjMAQUJqbXSjpaBTWM1JgsKwh7Jfgdk"
photologo = 'https://graph.org/file/b1a9cf2b0b0793a8a2625-f2caf6e2d44c2b8dbc.jpg' #https://envs.sh/fH.jpg/IMG20250803719.jpg
photoyt = 'https://graph.org/file/b1a9cf2b0b0793a8a2625-f2caf6e2d44c2b8dbc.jpg' #https://envs.sh/fH.jpg/IMG20250803719.jpg
photocp = 'https://graph.org/file/b1a9cf2b0b0793a8a2625-f2caf6e2d44c2b8dbc.jpg'
photozip = 'https://graph.org/file/b1a9cf2b0b0793a8a2625-f2caf6e2d44c2b8dbc.jpg'


# Inline keyboard for start command
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/OFFICIALMARCOWORLD")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/OFFICIALMARCOWORLD")        ],
    ]
)

# Image URLs for the random image feature
image_urls = [
    "https://graph.org/file/b1a9cf2b0b0793a8a2625-f2caf6e2d44c2b8dbc.jpg",
    "https://graph.org/file/b1a9cf2b0b0793a8a2625-f2caf6e2d44c2b8dbc.jpg",
    "https://graph.org/file/b1a9cf2b0b0793a8a2625-f2caf6e2d44c2b8dbc.jpg",
    ...
    try:
        if m.chat.type == "channel":
            ...
            if not is_authorized:
                await m.reply_photo(
                    photo=photologo,
                    caption="**Mʏ Nᴀᴍᴇ [𝐌 𝚨 𝐑 𝐂 𝚶](https://t.me/MARCOXWORLD)\n\nYᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴀᴄᴄᴇꜱꜱ ᴛᴏ ᴜꜱᴇ ᴛʜɪꜱ ʙᴏᴛ\nCᴏɴᴛᴀᴄᴛ [𝐌 𝚨 𝐑 𝐂 𝚶](https://t.me/OFFICIALMARCOWORLD) ғᴏʀ ᴀᴄᴄᴇꜱꜱ**",
                    reply_markup=InlineKeyboardMarkup([
    [
        InlineKeyboardButton("𝐌 𝚨 𝐑 𝐂 𝚶", url="https://t.me/OFFICIALMARCOWORLD")
    ],
    [
...
async def unauthorized_handler(client, message: Message):
    await message.reply(
        "<b>Mʏ Nᴀᴍᴇ [𝐌 𝚨 𝐑 𝐂 𝚶](https://t.me/OFFICIALMARCOWORLD)</b>\n\n"
        "<blockquote>You need to have an active subscription to use this bot.\n"
        "Please contact admin to get premium access.</blockquote>",
        reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton("💫 Get Premium Access", url="https://t.me/OFFICIALMARCOWORLD")
        ]])
    )
